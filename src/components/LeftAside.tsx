...
export function LeftAside({
    ...
    return (
        <div ref={sidebarRef} style={{ width, flexShrink: 0 }} className="relative h-full flex group border-r border-gray-200">
            <div 
            ...
            />
            <aside className="h-full bg-slate-50/50 overflow-y-auto flex flex-col p-4 w-full">
                <div className="mb-4">
                    ...
                    <div className="flex flex-col gap-1.5 flex-1">
                        {availableFiles.map((f) => (
                            <button
                                ...
                                className={cn(
                                    'px-3 py-2.5 rounded-lg text-sm text-left transition-colors flex items-center gap-3',
                                    activeFileId === f.id
                            ...
                            >
                                ...
                                <div className="truncate flex-1">{f.file.name}</div>
                            </button>
                        ))}
                    </div>
                )}
